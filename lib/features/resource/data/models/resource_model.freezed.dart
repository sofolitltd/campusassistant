...
@override@JsonKey(fromJson: _parseStringList, toJson: _stringListToJson) List<String> get tags {
  if (_tags is EqualUnmodifiableListView) return _tags;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_tags);
}

@override@JsonKey(name: 'is_public', fromJson: _parseBool) final  bool isPublic;
...
@override@JsonKey(fromJson: _parseStringList, toJson: _stringListToJson) List<String>? get years {
  final value = _years;
  if (value == null) return null;
