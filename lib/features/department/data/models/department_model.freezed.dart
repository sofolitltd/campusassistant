...
@override
String toString() {
  return 'DepartmentModel(id: $id, name: $name, acronym: $acronym, slug: $slug, universityId: $universityId, establishedYear: $establishedYear, about: $about, logoUrl: $logoUrl, websiteUrl: $websiteUrl, images: $images)';
}
...
class _DepartmentModel extends DepartmentModel {
  const _DepartmentModel({required this.id, required this.name, required this.acronym, required this.slug, required this.universityId, required this.establishedYear, required this.about, this.logoUrl = '', this.websiteUrl = '', final  List<String> images = const []}): _images = images,super._();
