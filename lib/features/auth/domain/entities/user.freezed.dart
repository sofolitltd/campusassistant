...
class _User extends User {
  const _User({required this.id, required this.email, required this.firstName, required this.lastName, required this.role, this.profileImage, this.phone, this.gender, this.batch, this.profession, this.session, this.hall, this.blood, this.isActive = true, this.isVerified = false, this.isPhonePublic = false, this.isEmailPublic = false, this.subscriptionStatus = 'basic', this.isModerator = false, this.isAdmin = false, this.isCr = false, this.universityId, this.departmentId}): super._();
